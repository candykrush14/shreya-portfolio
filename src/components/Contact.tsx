          ...
          >
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className={`w-12 h-12 bg-gradient-to-r ${info.color} rounded-lg flex items-center justify-center mr-4 group-hover:scale-110 transition-transform`}>
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <motion.a
                    ...
                    className={`text-gray-600 ${social.color} transition-colors font-medium`}
                  >
                    {social.name}
                  </motion.a>
                ))}
            ...
            >
              ...
              <p className="text-green-700 text-sm mt-1">
                Currently seeking exciting frontend engineering roles
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className={`w-full flex items-center justify-center px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl ${
